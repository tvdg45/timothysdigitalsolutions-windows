...
{
    public abstract class Website_Icon_Processor
    {
        ...
        private static void Create_new_table()
        {
            try
            {
                ...
                {
                    command.CommandText = "CREATE TABLE company_website_icon " +
                        "(row_id INT NOT NULL, file_path TEXT NOT NULL, date_received " +
                        "TEXT NOT NULL, time_received TEXT NOT NULL, " +
            ...
            {
                LOGGER.Debug("The 'company_website_icon' " +
        ...
        protected static int Search_row_count()
        {
            ...
            try
            {
                using (MySqlCommand command = connection.CreateCommand())
                {
                    command.CommandText = "SELECT row_id FROM company_website_icon " +
                        "ORDER BY row_id ASC";
